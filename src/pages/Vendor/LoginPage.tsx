    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-white">
      ...
      >
        ...
        <div className="absolute bottom-10 left-10 z-20 text-white max-w-md">
           <h2 className="text-4xl font-bold mb-4">Manage Your Business Like a Pro.</h2>
           <p className="text-lg text-white/90">Join thousands of vendors using Easy Q to streamline appointments and boost efficiency.</p>
        </div>
      </motion.div>

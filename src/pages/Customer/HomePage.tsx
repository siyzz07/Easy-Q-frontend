          ...
          >
            <div className="relative flex-1 w-full group">
              ...
              <input
                ...
                className="w-full h-12 rounded-xl bg-transparent pl-12 pr-4 text-sm font-medium outline-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full md:w-auto px-8 h-12 rounded-xl bg-primary text-primary-foreground font-bold disabled:opacity-50"
            >
              Search
            </button>
          </motion.div>
      ...
      <section className="mt-8 max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <button 
            ...
            className="lg:hidden flex items-center gap-2 font-semibold bg-white p-3 rounded-xl border"
          >

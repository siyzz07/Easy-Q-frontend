...
const DUMMY_MESSAGES: Message[] = [
  { id: '1', text: 'Hello! I noticed your contract for the plumbing service.', sender: 'other', timestamp: '10:00 AM', status: 'read' },
  { id: '2', text: 'Hi! Yes, I wanted to discuss the timeline.', sender: 'me', timestamp: '10:05 AM', status: 'read' },
  { id: '3', text: 'Sure, we can start by Monday.', sender: 'other', timestamp: '10:07 AM', status: 'read' },
  { id: '4', text: 'Great, that works for me!', sender: 'me', timestamp: '10:08 AM', status: 'delivered' },
];
...
const ChatPage = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] bg-[#efeae2] overflow-hidden relative">
      {/* Main Chat Area */}
      <div className={`flex-1 flex flex-col relative transition-all duration-300 ${showParticipants ? 'mr-0 md:mr-0' : ''}`}>
        
        {/* Background Pattern */}
        <div className="absolute inset-0 z-0 opacity-40 bg-[url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png')] bg-repeat"></div>
        ...
        <div className="relative z-20 bg-[#f0f2f5] px-4 py-3 flex items-center justify-between shadow-sm border-b border-[#d1d7db]">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3 cursor-pointer" onClick={() => setShowParticipants(true)}>
              ...
              <div className="flex flex-col">
                <h3 className="font-semibold text-[#111b21] leading-tight text-base">Contract #{id?.slice(0, 6)}</h3>
        ...
        <div className="relative z-10 flex-1 overflow-y-auto p-4 md:p-8 space-y-3 scrollbar-thin scrollbar-thumb-slate-300">
          {messages.map((msg) => (
            ...
            >
              ...
              >
                <div className="pb-1 break-words whitespace-pre-wrap">{msg.text}</div>
      ...
      >
          <div className="h-full flex flex-col">
            <div className="p-4 bg-[#f0f2f5] flex items-center gap-3 border-b border-light-200 flex-shrink-0">
                ...
                <h2 className="text-base font-medium text-[#111b21]">Contract Info</h2>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="p-6 flex flex-col items-center border-b border-faint-100 bg-white">
                    <div className="w-32 h-32 rounded-full bg-slate-100 mb-4 overflow-hidden shadow-inner cursor-pointer hover:opacity-90 transition-opacity">
                        <img src={`https://api.dicebear.com/7.x/initials/svg?seed=${id}`} alt="Group" className="w-full h-full object-cover" />
                    </div>
                    <h3 className="text-xl font-medium text-[#111b21] text-center">Contract #{id?.slice(0, 6)}</h3>
                    <p className="text-sm text-[#667781] mt-1">Created on 10/12/2025</p>
                     ...
                     <div className="flex gap-4 mt-6 w-full px-4">
                        <div className="flex-1 flex flex-col items-center gap-1 cursor-pointer group">
                             ...
                             <span className="text-xs text-[#00a884] font-medium">Audio</span>
                        </div>
                        <div className="flex-1 flex flex-col items-center gap-1 cursor-pointer group">
                             <div className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-[#00a884] group-hover:bg-[#f0f2f5] transition-colors shadow-sm">
                                <Video size={20} />
                             </div>
                             <span className="text-xs text-[#00a884] font-medium">Video</span>
                        </div>
                         <div className="flex-1 flex flex-col items-center gap-1 cursor-pointer group">
                             <div className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-[#00a884] group-hover:bg-[#f0f2f5] transition-colors shadow-sm">
                                <Search size={20} />
                             </div>
                             <span className="text-xs text-[#00a884] font-medium">Search</span>
                        </div>
                     </div>
                </div>
                ...
                <div className="p-4 bg-white">
                    <div className="px-2 pb-2">
                        <h4 className="text-sm text-[#667781] font-medium">Participants</h4>
                    </div>
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-3 hover:bg-[#f5f6f6] p-3 rounded-lg cursor-pointer transition-colors group">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-[#667781] truncate">Customer</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 hover:bg-[#f5f6f6] p-3 rounded-lg cursor-pointer transition-colors group">
                             ...
                             <div className="flex-1 min-w-0">
                                <p className="text-base text-[#111b21] truncate">John Doe</p>
                                <p className="text-xs text-[#667781] truncate">Piping & Plumbing Co.</p>
                            </div>
                            <div className="opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
                                <MessageCircle size={18} className="text-[#00a884] hover:scale-110 transition-transform" />
                                <Trash2 size={18} className="text-[#ea0038] hover:scale-110 transition-transform" />
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 hover:bg-[#f5f6f6] p-3 rounded-lg cursor-pointer transition-colors group">
                             ...
                             <div className="flex-1 min-w-0">
                                <p className="text-base text-[#111b21] truncate">Support Admin</p>
                                <p className="text-xs text-[#667781] truncate">EasyQ Support</p>
                            </div>
                            <div className="opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
                                <Trash2 size={18} className="text-[#ea0038] hover:scale-110 transition-transform" />
                            </div>

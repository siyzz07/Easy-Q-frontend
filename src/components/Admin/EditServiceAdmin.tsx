...
import { addServiceType, editServiceType } from "../../Services/AdminApiService";
...
interface IAddServicesAdmin {
  onClose: () => void;
  data: IServiceVendorTypes;
}

const EditServiceAdmin: FC<IAddServicesAdmin> = ({ onClose, data }) => {
  const initialValues = {
  ...
  const handleSubmit = async (values: any) => {
    try {
      const hasChange = Object.keys(initialValues).some(

import { Plus, Edit, Clock, IndianRupee, ImageOff, Search } from "lucide-react";
...
const Services = () => {
  ...
  useEffect(() => {
    getServicesData();
  }, [addServicePopup, editServicePopup,page,debounceSearch]);

  const getServicesData = async () => {
    try {
      setLoading(true);
      const response = await getServices(page,limit,debounceSearch);
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2.5 w-full sm:w-64 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm"
                />
              </div>

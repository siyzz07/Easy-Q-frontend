...
const Services = () => {
  ...
  useEffect(() => {
    getServicesData();
  }, [addServicePopup, editServicePopup,page,debouncedSearch]);
  ...
  return (
    <>
      {addServicePopup && (
        <AddService onClose={() => setAddServicePopup(false)} />
      )}
      {editServicePopup && (
        <EditService
          onClose={() => setEditServicePopup(false)}
          data={serviceEditData as IService}
        />
      )}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              <div className="relative w-full sm:w-80 group">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-2.5 bg-white border border-gray-200 rounded-md text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all shadow-sm"
                />
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-md font-medium shadow-md shadow-blue-200 transition-all active:scale-95 whitespace-nowrap"
              >
                <Plus size={18} />
                Add Service
              </button>
          ...
          {loading && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="bg-white rounded-xl shadow-sm p-4 animate-pulse h-80"
                >
